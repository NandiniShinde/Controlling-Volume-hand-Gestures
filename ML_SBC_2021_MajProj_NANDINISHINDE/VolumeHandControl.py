...
while True:
    ...
    if len(lmList) !=0:
        ...
        # 4 and 8 is the point of thumb and index finger
        ...
        cv2.circle(img,(x1 ,y1),15,(0,127,255), cv2.FILLED)
        cv2.circle(img,(x2 ,y2),15,(0,127,255), cv2.FILLED)
    
        cv2.line(img,(x1,y1),(x2,y2),(0,255,0),3)   #draw the line 
        ...
        if length <50:
            cv2.circle(img,(cx ,cy),15,(181,255,78), cv2.FILLED)
